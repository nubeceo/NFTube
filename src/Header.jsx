...
function Header() {
  return (
    <div className='text-white w-full h-11 flex items-center justify-between bg-black'>
      ...
      <div className='cursor-pointer flex items-center'>
        ...
        {/* menu icon */}
        <svg className='text-white fill-current m-6' xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="16" height="16" viewBox="0 0 50 50">
      ...
      <div className='w-80 cursor-pointer'>
        ...
        <div className='h-7 flex items-center bg-white w-full border rounded-2xl'>
          ...
          <input className='border-none h-full bg-transparent font-mono text-sm text-slate-900 focus:outline-none' type="text" placeholder='Search' />
      ...
      {/* third div */}
      <div className='m-6 flex items-center cursor-pointer'>
