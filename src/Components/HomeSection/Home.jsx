...
function Home() {
  ...
  // fetching feed on screen load
    ...
    // FetchFromApi(`search?part=snippet&maxResults=50&q=${selectedCategory}&key=AIzaSyA3VbXXid8BNWtXtLXbTXjXsipnYbwSpW4`)
    ...
    // https://youtube.googleapis.com/youtube/v3/search?part=snippet&maxResults=50&q=${selectedCategory}&key=AIzaSyA3VbXXid8BNWtXtLXbTXjXsipnYbwSpW4

    useEffect(() => {
      const fetchData = async () => {
        try {
          const response = await fetch(`https://youtube.googleapis.com/youtube/v3/search?part=snippet&maxResults=50&q=${selectedCategory}&key=AIzaSyA3VbXXid8BNWtXtLXbTXjXsipnYbwSpW4`);
          if (!response.ok) {
